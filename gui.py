...
class MineSweeperGui():
    def __init__(self, game_map):
        self.output_file = open("6x6.txt", 'w')
        self.game_count = 0.0
        self.win_count = 0.0
        self.lost_count = 0.0
        self.speed = 1
        ...
        if game_map is None:
            ...
            self.minesweeper_size = len(self.game_map)
    ...
    def generate_mines(self):
        ...
        print("min pos: ",self.mins_pos)
        return self.mins_pos

    def show(self):
        pygame.init()
        pygame.display.set_caption('QLearning Agent Minesweper similar check')
        # x_draw = self.GAME_WIDTH_SCREEN/2 - 50
